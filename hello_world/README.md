...
# C - Hello, World
## Details
Novice By: Julien Barbier Weight: 1Your score will be updated as you progress. ![](https://s3.eu-west-3.amazonaws.com/hbtn.intranet.project.files/holbertonschool-low_level_programming/212/cisfun.jpg) 
...
*  ` putchar ` 
## Learning Objectives
At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/GEjg-T3E5s_G9FeK4Idz5A) 
...
* Go to the [Betty](https://intranet.hbtn.io/rltoken/rZaN7lEaiI2xs60Xknp2CA) 
 repository
* Clone the [repo](https://intranet.hbtn.io/rltoken/rZaN7lEaiI2xs60Xknp2CA) 
...
### 0. Preprocessor
          mandatory         Progress vs Score  Task Body Write a script that runs a C file through the preprocessor and save the result into another file.
...
### 1. Compiler
          mandatory         Progress vs Score  Task Body Write a script that compiles a C file but does not link.
* The C file name will be saved in the variable  ` $CFILE ` 
...
* File:  ` 1-compiler ` 
 Self-paced manual review  Panel footer - Controls 
### 2. Assembler
          mandatory         Progress vs Score  Task Body Write a script that generates the assembly code of a C code and save it in an output file.
* The C file name will be saved in the variable  ` $CFILE ` 
...
* File:  ` 2-assembler ` 
 Self-paced manual review  Panel footer - Controls 
### 3. Name
          mandatory         Progress vs Score  Task Body Write a script that compiles a C file and creates an executable named   ` cisfun `  .
* The C file name will be saved in the variable  ` $CFILE ` 
```bash
julien@ubuntu:~/c/$ export CFILE=main.c
julien@ubuntu:~/c/$ cat main.c
...
* File:  ` 3-name ` 
 Self-paced manual review  Panel footer - Controls 
### 4. Hello, puts
          mandatory         Progress vs Score  Task Body Write a C program that prints exactly   ` "Programming is like building a multilingual puzzle `  , followed by a new line.
...
* File:  ` 4-puts.c ` 
 Self-paced manual review  Panel footer - Controls 
### 5. Hello, printf
          mandatory         Progress vs Score  Task Body Write a C program that prints exactly   ` with proper grammar, but the outcome is a piece of art, `  , followed by a new line.
...
### 6. Size is not grandeur, and territory does not make a nation
          mandatory         Progress vs Score  Task Body Write a C program that prints the size of various types on the computer it is compiled and run on.
...
* File:  ` 6-size.c ` 
 Self-paced manual review  Panel footer - Controls 
[Done with the mandatory tasks? Unlock 2 advanced tasks now!](https://intranet.hbtn.io/projects/2151/unlock_optionals) 

### Score
 ![Project badge](https://intranet.hbtn.io/assets/pathway/004_color-d2fbcfb42ba7481834896ecc89a6f0ae65762b3c1096691dd0f820f7f29e3389.png) 
Your score will be updated as you progress.
Please review  all the tasks  before you start the peer review.
Review all the tasksSkip this project×#### Recommended Sandbox
[Running only]() 
### 1 image(1/5 Sandboxes spawned)
### Ubuntu 20.04
Basic Ubuntu 20.04, with vim, emacs, curl, wget and all needed for Holberton Foundations
SSHSFTP[Webterm](https://intranet.hbtn.io/user_containers/28124/webterm) 
[Restart]() 
[Destroy]() 
#### Credentials
Hosta4af00592635.ae068b5a.hbtn-cod.ioUsernamea4af00592635Password93a921237acb7b400a2d#### Web access
[HTTPS](https://a4af00592635.ae068b5a.hbtn-cod.io/) 
[HTTP](http://a4af00592635.ae068b5a.hbtn-cod.io/) 
[3000](http://a4af00592635.ae068b5a.hbtn-cod.io:3000/) 
[4000](http://a4af00592635.ae068b5a.hbtn-cod.io:4000/) 
[5000](http://a4af00592635.ae068b5a.hbtn-cod.io:5000/) 
[5001](http://a4af00592635.ae068b5a.hbtn-cod.io:5001/) 
[8000](http://a4af00592635.ae068b5a.hbtn-cod.io:8000/) 
[8080](http://a4af00592635.ae068b5a.hbtn-cod.io:8080/) 
#### Port mapping
SSH32817HTTP32816HTTPS32815300032814MySQL32813400032812500032811500132810800032809808032808[Previous project](https://intranet.hbtn.io/projects/2022) 
